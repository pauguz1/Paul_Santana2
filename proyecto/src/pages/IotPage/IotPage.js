...
import obtenerSkillsIot from "../../services/TecnologiaIotService";
import obtenerProyectosIot from "../../services/ProyectosIotService";
...
const IotPage = ()=>{
    ...
    useEffect(()=>{
        const skill = obtenerSkillsIot();
        const proyecto = obtenerProyectosIot();
